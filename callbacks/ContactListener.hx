...
interface ContactListener {
	 ...
	 * @param contact
	 */
	function beginContact(contact : Contact) : Void;
	
	/**
	 * Called when two fixtures cease to touch.
	 * @param contact
	 */
	function endContact(contact : Contact) : Void;
	 ...
	 * @param oldManifold
	 */
	function preSolve(contact : Contact, oldManifold : Manifold) : Void;
	 ...
	 * this call
	 */
	function postSolve(contact : Contact, impulse : ContactImpulse) : Void;
